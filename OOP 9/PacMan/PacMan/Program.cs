...
namespace PacMan
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Ghost 5 (Horizontal) Information
            char previous5 = ' ';
            int ghost5X = 22;
            int ghost5Y = 56;
            ...
            // Ghost 7 (Random) Information
            char previous7 = ' ';
            int ghost7X = 19;
            int ghost7Y = 7;

            // Ghost 8 (Smart) Information
            char previous8 = ' ';
            int ghost8X = 2;
            int ghost8Y = 2;
