...
namespace ConsoleApp3
{
    class Program
    {
            ...
            do
            {
                ...
                if (option == "1")
                {
                    ...
                    if (user != null)
                    {
                        ...
                        {
                            Console.Clear();
                            adminInterface(users, players, coach, achievements, ref ticketPrices, matchSchedules);
                        }

                        else if (user.role == "Coach")
                        {
                            Console.Clear();
                            coachInterface(players, achievements, matchSchedules, trainingSchedules);
                        }
        ...
        static void adminInterface(List<Credentials> users, List<Player> players, List<Coach> coaches, List<string> achievements, ref int ticketPrices, List<MatchSchedule> matchSchedules)
        {
            string adminOption = "";
            do
            {
                ...
                else if (adminOption == "5")
                {
                    ...
                    {
                        Console.WriteLine("The limit has been exceeded");
                    }
                }
        ...
        static void coachInterface(List<Player> players, List<string> achievements, List<MatchSchedule> matchSchedules, List<TrainingSchedule> trainingSchedules)
        {
            string coachOption = "";
            do
            {
                ...
                if (decision == true)
                {
                    for (int idx = 0; idx < players.Count; idx++)
                    {
                        if ((players[idx].name == name))
                        {
                            ...
                            players[idx].addStats(runs, innings, wickets, highScore);
                        }
                    }
        ...
        static TrainingSchedule takeInputforTrainingSchedule()
        {
            Console.Write("       Date: ");
            string date = validateDate(Console.ReadLine());
            Console.Write("       Time: ");
            string time = validateTime(Console.ReadLine());
            TrainingSchedule training = new TrainingSchedule(time, date);
            return training;
        }
        ...
        static void scheduleTraining(List<TrainingSchedule> trainingSchedules)
        {
            ...
            while (userEnter != "0")
            {
                ...
                TrainingSchedule training = takeInputforTrainingSchedule();
        ...
        static void scheduleMatch(List<MatchSchedule> matchSchedules)
        {
            ...
            while (userEnter != "0")
            {
                ...
                MatchSchedule match = TakeScheduleInput();
        ...
        static MatchSchedule TakeScheduleInput()
        {
            ...
            MatchSchedule matchSchedule = new MatchSchedule(opposition, date, time, ground);
        ...
        static void removeCoach(List<Coach> coaches)
        {
        ...
        static void changePlayerName(List<Player> players)
        {
            string userEnter = "1";
            string name, role;
            bool decision;
            ...
            if (decision == true)
            {
                for (int idx = 0; idx < players.Count; idx++)
                {
                    if ((name == players[idx].name) && (role == players[idx].role))
                    {
                        ...
                        string name1 = validateString(Console.ReadLine());
                        players[idx].changeName(name1);
                    }
                }
            }
        ...
        static Credentials takeUserInput()
        {
        ...
        static void addUser(List<Credentials> users)
        {
            Credentials user = takeUserInput();

            if (user.role == "Coach" || user.role == "Player" || user.role == "Fan")
            {
                if (users.Count <= 99)
                {
                    users.Add(user);
        ...
        static void loadSchedule(List<MatchSchedule> matchSchedules)
        {
            ...
            while ((line = file.ReadLine()) != null)
            {
                string opposition = parseWord(line, 1);
                string date = parseWord(line, 2);
                string time = parseWord(line, 3);
                string ground = parseWord(line, 4);
                MatchSchedule matchSchedule = new MatchSchedule(opposition, date, time, ground);
        ...
        static void loadTraining(List<TrainingSchedule> trainingSchedules)
        {
            ...
            while ((line = file.ReadLine()) != null)
            {
                string date = parseWord(line, 1);
                string time = parseWord(line, 2);
                TrainingSchedule matchSchedule = new TrainingSchedule(date, time);
