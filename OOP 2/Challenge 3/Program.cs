...
namespace Challenge_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Credentials> usersArray = new List<Credentials>();
            int option;
            int count = 0;
        ...
        static void readData(string path, List<Credentials> user, ref int count)
        {
            if (File.Exists(path))
            {
        ...
        static void signIn(string n, string p, List<Credentials> user, int count)
        {
            bool flag = false;
        ...
        static void storeData(List<Credentials> user, int count, string path)
        {
        ...
        static Credentials readUser(string record)
        {
        ...
        {
            Credentials addingUser = new Credentials();
