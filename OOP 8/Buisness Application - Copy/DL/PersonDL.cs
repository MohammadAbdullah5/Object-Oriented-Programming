    ...
    class PersonDL
    {
        ...
        public static int isValidCoachAndReturnIndex(string name, string role)
        {
            for (int i = 0; i < people.Count; i++)
            {
                ...
                {
                    if (people[i].getName() == name && people[i].getCoachRole() == role)
                    {
                        return i;
                    }
                }
        ...
        public static Player isValidPlayer(string name, string role)
        {
            foreach (Person person in people)
            {
                if (person.toString() == "Player")
                {
                    if (person.getName() == name && person.getPlayerRole() == role)
                    {
                        return (Player)person;
                    }
                }
        ...
        public static int isValidPlayerAndReturnIndex(string name, string role)
        {
            for (int i = 0; i < people.Count; i++)
            {
                ...
                {
                    if (people[i].getName() == name && people[i].getPlayerRole() == role)
                    {
                        return i;
                    }
                }
        ...
        public static void storeCricketersData(string path)
        {
            ...
            for (int idx = 0; idx < people.Count(); idx++)
            {
                ...
                {
                    if (people[idx].getStats() != null)
                    {
                        Stats stats = people[idx].getStats();
                    ...
                    file.WriteLine(people[idx].getName() + "," + people[idx].getPlayerRole() + "," + people[idx].getBattingStyle() + "," + people[idx].getBowlingStyle() + "," + people[idx].getAge() + "," + people[idx].getSalary() + "," + record + "," + recordUser);
                }
            }
            file.Flush();
            file.Close();
        ...
        public static void storeCoachesData(string path)
        {
            ...
            for (int idx = 0; idx < people.Count(); idx++)
            {
                ...
                if (people[idx].toString() == "Coach")
                {
                    ...
                    file.WriteLine(people[idx].getName() + "," + people[idx].getCoachRole() + "," + people[idx].getAge() + "," + people[idx].getSalary() + "," + record);
                }
            }
